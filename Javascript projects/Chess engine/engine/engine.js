class engine {
    ...
    getPassedPawnBonus(color) {
        ...
        for (let index of pawnSquares) {
            ...
            const frontMask = color == "w" ? (0xFFFFFFFFFFFFFFFFn >> BigInt(8 * (8 - j))) & cutMask : (0xFFFFFFFFFFFFFFFFn << BigInt(8 * (j + 1))) & cutMask;
            const passedPawnMask = tripleFileMask & frontMask;
